...
class IngestionService:
    ...
    def __init__(self, use_duckdb: bool = True, min_rows_lstm: int = 100):
        ...
        self._last_processed_info: Optional[Dict] = None
    ...
    def get_last_processed_info(self) -> Optional[Dict]:
    ...
    def _auto_detect_cols(self, columns: List[str]) -> Tuple[Optional[str], Optional[str]]:
